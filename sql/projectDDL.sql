...
CREATE TABLE Publisher (
    ...
    address VARCHAR(300) NOT NULL,
    phoneNumber VARCHAR(10) CHECK (LENGTH(phoneNumber) = 10) UNIQUE,
	bankAccount INT UNIQUE,
    FOREIGN KEY (bankAccount)
        REFERENCES bankaccount (number)
);
...
CREATE TABLE Book (
    ISBN VARCHAR(13) CHECK (LENGTH(ISBN) = 13) PRIMARY KEY,
...
CREATE TABLE UserOrder (
    ...
    address VARCHAR(300) NOT NULL,
    creditCard CHAR(16) CHECK (LENGTH(creditCard) = 16) NOT NULL,
    CVV CHAR(3) NOT NULL CHECK (LENGTH(CVV) = 3), 
    expiry CHAR(5) NOT NULL,
	username VARCHAR(70) NOT NULL,
	ISBN VARCHAR(13) CHECK (LENGTH(ISBN) = 13) NOT NULL,
...
CREATE TABLE StoreOrder (
    ...
    quantity INT NOT NULL,
    date CHAR(10) NOT NULL,
	ISBN VARCHAR(13) CHECK (LENGTH(ISBN) = 13) UNIQUE NOT NULL,
    FOREIGN KEY (ISBN)
        REFERENCES Book (ISBN)
);
...
VALUES  ('matt@user.com', 'Matt', 'User', '123456', 'user', '1 Road Lane A1B2C3 Ottawa Ontario Canada', 6),
        ('vincent@user.com', 'Vincent', 'User1', '9876', 'user', '2 Street Road G4H5I6 Quebec Quebec Canada', 7),
        ('rachel@employee.com', 'Rachel', 'User2', '7172', 'employee', '3 Crescent Street J8K9L2 Vancouver British Columbia Canada', 8),
        ('admin@employee.com', 'Admin', 'Employee', '0000', 'employee', '2 Boulevard Crescent E2F7G1 Toronto Ontario Canada', 9);
...
/* UserOrder */
INSERT INTO UserOrder(cost, quantity, date, address, creditCard, CVV, expiry, username, ISBN)
VALUES  (12.99, 2, '12/07/2022', '1 Road Lane A1B2C3 Ottawa Ontario Canada', '1234567890123456', '123', '09/25', 'matt@user.com', '9780063215382'),
        (12.99, 1, '11/02/2022', '1 Road Lane A1B2C3 Ottawa Ontario Canada', '1234567890123456', '123', '09/25', 'matt@user.com', '9781478948278'),
        ...
        (22.99, 2, '11/02/2022', '1 Road Lane A1B2C3 Ottawa Ontario Canada', '1234567890123456', '123', '09/25', 'matt@user.com', '9781501110344'),
        (22.99, 4, '11/02/2022', '1 Road Lane A1B2C3 Ottawa Ontario Canada', '1234567890123456', '123', '09/25', 'matt@user.com', '9781501110368'),
        (22.99, 1, '11/02/2022', '1 Road Lane A1B2C3 Ottawa Ontario Canada', '1234567890123456', '123', '09/25', 'matt@user.com', '9781538724736'),
